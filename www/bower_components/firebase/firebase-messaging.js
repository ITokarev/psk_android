!function (e, t) {
  ...
  try {
    ...
    var a = "FirebaseError",
        ...
        u = function () {
      return function (e, t) {
        if (this.code = e, this.message = t, c) c(this, h.prototype.create);else {
    ...
    (function (e) {
      ...
      r(t, e), t.prototype.reset = function () {
        ...
        t || (t = 0);
        var n = this.W_;
        if ("string" == typeof e) for (var r = 0; r < 16; r++) n[r] = e.charCodeAt(t) << 24 | e.charCodeAt(t + 1) << 16 | e.charCodeAt(t + 2) << 8 | e.charCodeAt(t + 3), t += 4;else for (r = 0; r < 16; r++) n[r] = e[t] << 24 | e[t + 1] << 16 | e[t + 2] << 8 | e[t + 3], t += 4;
  ...
  var F;
}(this.firebase = this.firebase || {}, firebase); //# sourceMappingURL=firebase-messaging.js.map