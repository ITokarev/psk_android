!function (t, e) {
  ...
  try {
      ...
      switch (t) {
        ...
        case g.DATA_URL:
          return new R(function (t) {
            var e = new T(t);
            return e.base64 ? U(g.BASE64, e.rest) : function (t) {
              var e;
    ...
    function w(t) {
      for (var e = [], r = 0; r < t.length; r++) {
        ...
        if (n <= 127) e.push(n);else if (n <= 2047) e.push(192 | n >> 6, 128 | 63 & n);else if (55296 == (64512 & n)) {
          if (r < t.length - 1 && 56320 == (64512 & t.charCodeAt(r + 1))) n = 65536 | (1023 & n) << 10 | 1023 & t.charCodeAt(++r), e.push(240 | n >> 18, 128 | n >> 12 & 63, 128 | n >> 6 & 63, 128 | 63 & n);else e.push(239, 191, 189);
    ...
    function U(t, e) {
      switch (t) {
        case g.BASE64:
          var r = -1 !== e.indexOf("-"),
              n = -1 !== e.indexOf("_");
          if (r || n) throw b(t, "Invalid character '" + (r ? "-" : "_") + "' found: is it base64url encoded?");
          break;

        case g.BASE64URL:
          var o = -1 !== e.indexOf("+"),
              i = -1 !== e.indexOf("/");
          if (o || i) throw b(t, "Invalid character '" + (o ? "+" : "/") + "' found: is it base64 encoded?");
    ...
    var T = function () {
      return function (t) {
        ...
        var e = t.match(/^data:([^,]+)?,/);
        if (null === e) throw b(g.DATA_URL, "Must be formatted 'data:[<mediatype>][;base64],<data>");
        var r = e[1] || null;
    ...
    var H = function () {
      function t() {
        var t = this;
        this.sent_ = !1, this.xhr_ = new XMLHttpRequest(), this.errorCode_ = A.NO_ERROR, this.sendPromise_ = P(function (e, r) {
    ...
    function et() {
      ...
      return r.xform = function (t, e) {
        return D(e) ? +e : e;
      }, t.push(r), t.push(new $("timeCreated")), t.push(new $("updated")), t.push(new $("md5Hash", null, !0)), t.push(new $("cacheControl", null, !0)), t.push(new $("contentDisposition", null, !0)), t.push(new $("contentEncoding", null, !0)), t.push(new $("contentLanguage", null, !0)), t.push(new $("contentType", null, !0)), t.push(new $("metadata", "customMetadata", !0)), t.push(new $("downloadTokens", "downloadURLs", !1, function (t, e) {
    ...
    function Ut(t, e, r, n, o, i, a, s) {
      ...
      var m = e.maxUploadRetryTime(),
          g = new _t(r, "POST", function (t, r) {
        var o,
            a = wt(t, ["active", "final"]),
            s = u.current + p,
            c = n.size();
        return o = "final" === a ? bt(e, i)(t, r) : null, new Et(s, c, "final" === a, o);
      }, m);
      return g.headers = v, g.body = b.uploadData(), g.progressCallback = s || null, g.errorHandler = mt(t), g;
    }

    var Tt = function () {
      return function (t, e, r) {
        if (W(t) || D(e) || D(r)) this.next = t, this.error = e || null, this.complete = r || null;else {
          var n = t;
    ...
    var Ot = function () {
      ...
      return t.prototype.makeProgressCallback_ = function () {
        ...
        this.resolveToken_(function (e) {
          var r = function (t, e, r, n, o) {
            ...
            return p.urlParams = s, p.headers = c, p.body = l, p.errorHandler = mt(e), p;
        ...
        this.resolveToken_(function (o) {
          ...
          try {
            i = Ut(t.location_, t.authWrapper_, n, t.blob_, e, t.mappings_, r, t.makeProgressCallback_());
          } catch (e) {
        ...
        this.resolveToken_(function (e) {
          var r = function (t, e, r, n, o) {
            ...
            return v.urlParams = p, v.headers = a, v.body = h.uploadData(), v.errorHandler = mt(e), v;
          }(t.authWrapper_, t.location_, t.mappings_, t.blob_, t.metadata_),
              n = t.authWrapper_.makeRequest(r, e);
        ...
        get: function () {
          var t = S(this.state_);
          return new At(this.transferred_, this.blob_.size(), t, this.metadata_, this, this.ref_);
        },
        enumerable: !0,
        configurable: !0
        ...
        function c(t) {
          return function (e, r, o) {
            ...
            var i = new Tt(e, r, n);
            return u.addObserver_(i), function () {
              u.removeObserver_(i);
            };
          };
        }
      ...
      return t.prototype.toString = function () {
        return it("toString", [], arguments), "gs://" + this.location.bucket + "/" + this.location.path;
        ...
        return void 0 === e && (e = null), it("put", [new at(function (t) {
          if (!(t instanceof Uint8Array || t instanceof ArrayBuffer || F() && t instanceof Blob)) throw "Expected Blob or File.";
        }), ut(!0)], arguments), this.throwIfRoot_("put"), new Ot(this, this.authWrapper, this.location, this.mappings(), new ft(t), e);
      }, t.prototype.putString = function (t, e, r) {
        void 0 === e && (e = g.RAW), it("putString", [st(), st(y, !0), ut(!0)], arguments), this.throwIfRoot_("putString");
        var n = E(e, t),
            o = L(r);
        return !D(o.contentType) && D(n.contentType) && (o.contentType = n.contentType), new Ot(this, this.authWrapper, this.location, this.mappings(), new ft(n.data, !0), o);
        ...
        return this.authWrapper.getAuthToken().then(function (e) {
          var r = function (t, e) {
            ...
            return o.successCodes = [200, 204], o.errorHandler = gt(e), o;
        ...
        it("updateMetadata", [ut()], arguments), this.throwIfRoot_("updateMetadata");
        var e = this;
        return this.authWrapper.getAuthToken().then(function (r) {
          var n = function (t, e, r, n) {
            ...
            return s.headers = {
              "Content-Type": "application/json; charset=utf-8"
            }, s.body = i, s.errorHandler = gt(e), s;
          }(e.authWrapper, e.location, t, e.mappings());

          return e.authWrapper.makeRequest(n, r).getPromise();
        });
      }, t.prototype.getDownloadURL = function () {
        return it("getDownloadURL", [], arguments), this.throwIfRoot_("getDownloadURL"), this.getMetadata().then(function (t) {
          var e = t.downloadURLs[0];
          if (D(e)) return e;
          throw new c(l.NO_DOWNLOAD_URL, "The given file does not have any download URLs.");
        });
      ...
      function t(e, r, n, o, i) {
        ...
        this.storageRefMaker_ = r, this.requestMaker_ = n, this.pool_ = i, this.service_ = o, this.maxOperationRetryTime_ = a, this.maxUploadRetryTime_ = s, this.requestMap_ = new kt();
      }
    ...
    var Lt = function () {
      ...
      return t.prototype.start_ = function () {
        ...
        this.canceled_ ? e(0, new Pt(!1, null, !0)) : this.backoffId_ = function (t, e, r) {
          var n = 1,
              o = null,
              i = !1,
              a = 0;
    ...
    function xt(t, r, n) {
      ...
      }(a), new Lt(i, t.method, a, t.body, t.successCodes, t.additionalRetryCodes, t.handler, t.errorHandler, t.timeout, t.progressCallback, n);
    }

    var Dt = function () {
      function t(t, e, r) {
        if (this.bucket_ = null, this.authWrapper_ = new It(t, function (t, e) {
          return new Ct(t, e);
        }, xt, this, e), this.app_ = t, null != r) this.bucket_ = V.makeFromBucketSpec(r);else {
      ...
      return t.prototype.ref = function (t) {
        ...
        return it("refFromURL", [st(function (t) {
        ...
        }, !1)], arguments), new Ct(this.authWrapper_, t);
        ...
        it("setMaxUploadRetryTime", [ct()], arguments), this.authWrapper_.setMaxUploadRetryTime(t);
        ...
        it("setMaxOperationRetryTime", [ct()], arguments), this.authWrapper_.setMaxOperationRetryTime(t);
  ...
  var Gt;
}(this.firebase = this.firebase || {}, firebase); //# sourceMappingURL=firebase-storage.js.map