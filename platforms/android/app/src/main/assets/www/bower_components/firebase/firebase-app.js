!function (t, e) {
  ...
  var k = x,
    ...
    return function (e, u, f) {
      for (var h, p, l = Object(I(e)), d = D(l), y = S(u, f, 3), v = C(d.length), b = 0, m = r ? c(e, v) : n ? c(e, 0) : void 0; v > b; b++) if ((a || b in d) && (p = y(h = d[b], b, l), t)) if (r) m[b] = p;else if (p) switch (t) {
        case 3:
          return !0;
  ...
  var st = "FirebaseError",
      ...
      ct = function () {
    return function (t, e) {
      if (this.code = t, this.message = e, at) at(this, ut.prototype.create);else {
  ...
  !function (t) {
    ...
    (function (t, e) {
      ...
      e || (e = 0);
      var r = this.W_;
      if ("string" == typeof t) for (var n = 0; n < 16; n++) r[n] = t.charCodeAt(e) << 24 | t.charCodeAt(e + 1) << 16 | t.charCodeAt(e + 2) << 8 | t.charCodeAt(e + 3), e += 4;else for (n = 0; n < 16; n++) r[n] = t[e] << 24 | t[e + 1] << 16 | t[e + 2] << 8 | t[e + 3], e += 4;
      ...
      if (null != t) {
        ...
        for (var r = e - this.blockSize, n = 0, o = this.buf_, i = this.inbuf_; n < e;) {
          if (0 == i) for (; n <= r;) this.compress_(t, n), n += this.blockSize;

          if ("string" == typeof t) {
            for (; n < e;) if (o[i] = t.charCodeAt(n), ++n, ++i == this.blockSize) {
              this.compress_(o), i = 0;
              break;
            }
          } else for (; n < e;) if (o[i] = t[n], ++n, ++i == this.blockSize) {
            this.compress_(o), i = 0;
            break;
          }
        }
      ...
      for (r = 0; r < 5; r++) for (var o = 24; o >= 0; o -= 8) t[n] = this.chain_[r] >> o & 255, ++n;
